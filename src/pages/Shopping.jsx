...
const Shopping = () => {
  ...
  return (
    <div className='px-[7.5%] py-[40px] flex flex-col sm:flex-row justify-between gap-[40px]'>
      <div className='sm:w-[50%] flex flex-col'>
        <h2 className="text-[23px] sm:text-[26px] font-bold">Shopping Cart</h2>
      ...
      <div className='sm:w-[50%] flex flex-col gap-[20px]'>
        <h2 className="text-[23px] sm:text-[26px] font-bold">Order Summary</h2>
